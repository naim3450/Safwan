...
const Client = () => {
    ...
    return (
        <div className='w-[100%] h-[85vh] bg-[#F9F4F1] relative'>
            ...
            <Container>
                <CommonSvgText text={`Client Testimonial`} className={`justify-center pt-[150px]`} />
                <CommonTitle text={`Feedback From Client`} className={`text-center pt-[20px]`} />

                <Slider {...settings} className='mt-[50px] pb-[70px]'>
                    <ClientCard />
                    <ClientCard />
                    <ClientCard />
                </Slider>
